...
- Out-of-distribution generalisation in deep neural networks:
    ...
    - examples of DNNs' failures when the data distribution shifts
        ...
        - noisy data [[23]](https://github.com/YHJYH/Machine_Learning/blob/main/projects/Master_Thesis/papers/Deep_NNs_are_Easily_Fooled.md#deep-neural-networks-are-easily-fooled-high-confidence-predictions-for-unrecognizable-images) [[27]]()
